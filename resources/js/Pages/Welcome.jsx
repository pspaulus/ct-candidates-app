                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        Herramienta de gestión simple y efectiva
                                        que permite a las personas organizar,
                                        planificar y realizar un seguimiento de
                                        sus tareas pendientes. La idea básica es
                                        crear una lista de cosas por hacer y
                                        marcarlas a medida que se completan.
                                    </p>
                                </div>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        El uso de un To-Do List es una práctica
                                        común para mejorar la productividad y la
                                        gestión del tiempo tanto en el ámbito
                                        personal como profesional. Su
                                        simplicidad y versatilidad lo convierten
                                        en una herramienta efectiva para
                                        cualquier persona que desee mantenerse
                                        organizada y cumplir con sus objetivos
                                        diarios.
                                    </p>
                                </div>
